...
AppFrame             APPLICATION('TopSpeed University'),AT(,,671,381),FONT('Microsoft Sans Serif',8,COLOR:Black), |
  RESIZE,ALRT(MouseLeft2),ICON('_TPSPDU.ICO'),MAX,HLP('~TopSpeedUniversity'),STATUS(-1,80, |
  120,45),SYSTEM,IMM
  ...
  ' Description')
                         ...
                         END
                       END
                       TOOLBAR,AT(0,0,671,16),USE(?TOOLBAR1)
