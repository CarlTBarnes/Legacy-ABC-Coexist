...
SetDynamicControlsAttributes    ROUTINE
PrepareProcedure ROUTINE
  Message('Classes::Used='  &    Classes::Used & ' Status=' & Status(Classes) & |
          '|Courses::Used='  &   Courses::Used & ' Status=' & Status(Courses) & |
          '|Teachers::Used=' &   Teachers::Used & ' Status=' & Status(Teachers) & |
          '') 
  IF Classes::Used = 0
    CheckOpen(Classes,1)
  END
